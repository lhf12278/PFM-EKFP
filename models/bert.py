...
class Bert(nn.Module):
    def __init__(self): 
        ...
        self.tokenizer = BertTokenizer.from_pretrained('./data/project_directory/pretrained_models/bert-base-uncased/bert-base-uncased-vocab.txt')
        modelConfig = BertConfig.from_pretrained('./data/project_directory/pretrained_models/bert-base-uncased/bert_config.json')
        self.textExtractor = BertModel.from_pretrained(
            './data/project_directory/pretrained_models/bert-base-uncased/pytorch_model.bin', config=modelConfig)
