...
def parse_args():
    ...
    parser.add_argument('--img_root', type=str, default='/opt/data/private/Datasets/ICFG-PEDES/imgs')
    parser.add_argument('--json_root', type=str, default='/opt/data/private/Datasets/ICFG-PEDES/ICFG-PEDES.json')
    parser.add_argument('--out_root', type=str, default='/opt/data/private/Projects/SAF-set/SAF-CLIP-MGLC-CG-ICFG/icfgpedes/processed_data')
